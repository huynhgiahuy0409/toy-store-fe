...
function () {
  ...
  SummaryBoxComponent.prototype.getSummaryCart = function (orders) {
    ...
    orders === null || orders === void 0 ? void 0 : orders.forEach(function (order) {
      var priceUnit = order.priceUnit,
          discountPercent = order.discountPercent,
          quantity = order.quantity;
      _this.summaryCart.subTotal += Math.round((100 - discountPercent) * priceUnit * quantity / 100 / 1000) * 1000;
    });
  ...
  SummaryBoxComponent.prototype.getGrandTotal = function () {
    this.summaryCart.grandTotal = this.summaryCart.subTotal + this.summaryCart.tax - this.getCouponInSubTotal(this.summaryCart.subTotal);
  };
  ...
  SummaryBoxComponent = __decorate([core_1.Component({
    selector: 'app-summary-box',
    templateUrl: './summary-box.component.html',
    styleUrls: ['../template/css/style.css', '../template/css/custom.css', '../template/css/responsive.css', '../template/css/bootstrap.min.css']
  })], SummaryBoxComponent);
