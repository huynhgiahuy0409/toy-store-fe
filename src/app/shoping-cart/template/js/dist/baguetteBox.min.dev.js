...
!function (e, t) {
  ...
  "function" == typeof define && define.amd ? define(t) : "object" == (typeof exports === "undefined" ? "undefined" : _typeof(exports)) ? module.exports = t() : e.baguetteBox = t();
}(void 0, function () {
  "use strict";
  ...
  function S(i, a) {
    if (d !== i) {
      ...
      for (var s, l = [], c = [], f = 0; f < i.length; f++) {
        (s = W("div")).className = "full-image", s.id = "baguette-img-" + f, h.push(s), l.push("baguetteBox-figure-" + f), c.push("baguetteBox-figcaption-" + f), t.appendChild(h[f]);
      }
  ...
  return [].forEach || (Array.prototype.forEach = function (e, t) {
    ...
    destroy: function destroy() {
      ...
      a = c.passiveEvents ? {
        passive: !0
      } : null, V(e, "click", w), V(n, "click", k), V(o, "click", x), V(i, "click", C), V(t, "contextmenu", N), V(e, "touchstart", E, a), V(e, "touchmove", B, a), V(e, "touchend", T), V(document, "focus", L, !0), function () {
        for (var e in v) {
          v.hasOwnProperty(e) && A(e);
        }
