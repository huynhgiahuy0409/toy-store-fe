...
var MyServerHttpService = /** @class */ (function () {
    ...
    MyServerHttpService.prototype.getAllProducts = function () {
        var url = this.REST_API_SERVER + "/products";
        return this.httpClient
            .get(url, this.httpOptions)
            .pipe(operators_1.catchError(this.handleError));
    };
    ...
    MyServerHttpService.prototype.addToDetail = function (item) {
        var url = this.REST_API_SERVER + "/detail";
        return this.httpClient
            .put(url, item, this.httpOptions)
            .pipe(operators_1.catchError(this.handleError));
    };
    ...
    MyServerHttpService = __decorate([
        core_1.Injectable({
            providedIn: 'root'
        })
    ], MyServerHttpService);
